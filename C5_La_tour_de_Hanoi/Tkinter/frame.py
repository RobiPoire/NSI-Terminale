"""
Hanoi Project - Tkinter frame
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Fichier contenant les fonctions pour les frames.
"""
...
class Frame:
    ...
    def create(self):
        ...
        # Définition d'un protocole de fermeture de la fenêtre
        self.frame.protocol("WM_DELETE_WINDOW", self.onClose)
        self.frame.title(self.title)  # Définition du titre de la fenêtre
        # Définition de la taille de la fenêtre
        self.frame.geometry(f"{self.width}x{self.height}")
        # Définition de la couleur de fond
        self.frame.configure(background=self.backgroundColor)
    ...
    def paintComponent(self):
        ...
        for disc in Discs:
            # Définition de la taille du disque en fonction de la taille de la fenêtre
            disc.sizeDiscWidth = (200 / len(Discs)) * self.width / 1280
            # Définition de la taille du disque en fonction de la taille de la fenêtre
            disc.sizeDiscHeight = (200 / len(Discs)) * self.height / 720
